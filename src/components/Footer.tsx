    ...
    <footer className="bg-lagori-900 text-white pt-16 pb-8">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
          <p>© {new Date().getFullYear()} Lagori Foundation  | Designed by <a href="https://www.dievektor.tech" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">dieVektor.tech</a> | All rights reserved</p>
        </div>
      </div>
    </footer>
  );
