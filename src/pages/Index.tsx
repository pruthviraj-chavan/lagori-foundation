    ...
    <PageTransition>
      <main className="overflow-hidden">
        ...
        <section className="relative min-h-screen flex items-center">
          <div className="absolute inset-0 bg-gradient-to-r from-lagori-900/90 to-lagori-700/90">
            <div className="absolute inset-0 mix-blend-overlay opacity-20 bg-[url('https://images.unsplash.com/photo-1554244933-d876deb6b2ff?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2080&q=80')]"></div>
          </div>
          ...
          <div className="container max-w-7xl mx-auto px-4 sm:px-6">
            ...
            >
              <div className="text-center p-6 bg-white rounded-2xl shadow-md">
                <div className="text-lagori-600 font-bold text-4xl mb-2">500+</div>
                <p className="text-gray-600">Active Members</p>
              </div>
              <div className="text-center p-6 bg-white rounded-2xl shadow-md">
                <div className="text-lagori-600 font-bold text-4xl mb-2">4</div>
                <p className="text-gray-600">Years of Service</p>
              </div>
              <div className="text-center p-6 bg-white rounded-2xl shadow-md">
                <div className="text-lagori-600 font-bold text-4xl mb-2">10,000+</div>
                <p className="text-gray-600">Women Helped</p>
              </div>
              <div className="text-center p-6 bg-white rounded-2xl shadow-md">
                <div className="text-lagori-600 font-bold text-4xl mb-2">10-15</div>
                <p className="text-gray-600">Marriages Restored</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section-container bg-lagori-50">
          <div className="container max-w-7xl mx-auto px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-16 animate-fade-in">
              ...
              <h2 className="section-title">Inspiring Stories of Transformation</h2>
              <p className="section-subtitle">
